/* 
Ahora, crea una clase ejecutable (MAIN CLASS) que haga lo siguiente:
...
altura y el último valores por defecto, para este último utiliza los métodos set para darle a
los atributos un valor.
3. Para cada objeto, se deberá comprobar si la persona a la que representa el objeto está en
su peso ideal, tiene sobrepeso o se encuentra por debajo de su peso ideal con un mensaje.
