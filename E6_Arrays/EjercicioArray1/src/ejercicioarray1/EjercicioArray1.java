...
public class EjercicioArray1 {
    ...
    /**
     * 1) Escribir un programa que pida 10 números enteros por teclado y que
     * imprima por pantalla: i. Cuántos de esos números son pares. ii. Cuál es
     * el valor del número máximo. iii. Cuál es el valor del número mínimo.
     */
    public static void main(String[] args) {
        ...
        //Pedimos los 10 números y validamos que sean valores entre 0 y 10 INCLUSIVE:
        ...
        for (int i = 0; i < arrayNumeros.length; i++) {
            ...
            } while ((arrayNumeros[i] < 0) || (arrayNumeros[i] > 10));
