package ejemplousoarray_7;

import java.io.File;
import java.io.FileNotFoundException;
import java.util.Scanner;

public class EjemploUsoArray_7 {

    public static void main(String[] args) throws FileNotFoundException {
        File archivo = new File("src/ejemplousoarray_7/datos");
        Scanner entrada = new Scanner(archivo);
        Scanner entradaFila;//Scanner que recorre cada fila leída
        /*En este ejemplo leeremos una matriz irregular de 4 filas, siendo el número de columnas desconocido para cada fila*/
